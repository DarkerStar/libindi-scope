	...
	indi_test::lvalue_functors<int>)
{
	...
	{
		auto func = Func{call_count};
		auto scope_guard = indi::scope_success<Func&>{func};
		BOOST_TEST(call_count == 0, "function called before scope exit");
	...
	indi_test::rvalue_functors<int>)
{
	...
	// Artificial scope
	{
		auto scope_guard = indi::scope_success{Func{call_count}};
		BOOST_TEST(call_count == 0, "function called before scope exit");
	...
	indi_test::lvalue_functors<int>)
{
	...
	auto p_scope_guard_1 = std::unique_ptr<indi::scope_success<Func&>>{new indi::scope_success<Func&>{func}};
	BOOST_TEST(call_count == 0); // sanity check

	auto p_scope_guard_2 = std::unique_ptr<indi::scope_success<Func&>>{new indi::scope_success{std::move(*p_scope_guard_1)}};
	...
	indi_test::rvalue_functors<int>)
{
	...
	auto p_scope_guard_1 = std::unique_ptr<indi::scope_success<Func>>{new indi::scope_success{Func{call_count}}};
	BOOST_TEST(call_count == 0); // sanity check
