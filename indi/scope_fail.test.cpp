	...
	indi_test::lvalue_functors<int>)
{
	...
	{
		auto func = Func{call_count};
		auto scope_guard = indi::scope_fail<Func&>{func};
		BOOST_TEST(call_count == 0, "function called before scope exit");
	...
	indi_test::rvalue_functors<int>)
{
	...
	// Artificial scope
	{
		auto scope_guard = indi::scope_fail{Func{call_count}};
		BOOST_TEST(call_count == 0, "function called before scope exit");
...
/*****************************************************************************
 * Move after release tests
 ****************************************************************************/

BOOST_AUTO_TEST_CASE_TEMPLATE(
	move_after_release_WITH_lvalue_CASE_success,
	Func,
	indi_test::lvalue_functors<int>)
{
	auto call_count = 0;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
	move_after_release_WITH_rvalue_CASE_success,
	Func,
	indi_test::rvalue_functors<int>)
{
	auto call_count = 0;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
	move_after_release_WITH_lvalue_CASE_fail,
	Func,
	indi_test::lvalue_functors<int>)
{
	using scope_fail_ptr = std::unique_ptr<indi::scope_fail<Func&>>;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(
	move_after_release_WITH_rvalue_CASE_fail,
	Func,
	indi_test::rvalue_functors<int>)
{
	using scope_fail_ptr = std::unique_ptr<indi::scope_fail<Func>>;
